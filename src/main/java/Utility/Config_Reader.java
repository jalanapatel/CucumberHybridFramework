...
//  public class static Config_Reader                                                                  // Create Class to  Read config.properties file  ---> to avoid static 


public class Config_Reader                                                                  // Create Class to  Read config.properties file and create Object of Config_Reader_Class, in respective_Class in which Config_Reader used.

{
		
			public  Properties  initializeProperties()                              // create method to initialize config.properties fiel for browser level data and return type is Properties.
			{
