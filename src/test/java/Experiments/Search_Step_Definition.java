...
public class Search_Step_Definition 
{
	...
	public void user_should_get_a_message_about_no_product_matching() 
	{
		...
		Assert.assertEquals(driver.findElement(By.xpath("//input[@id='button-search']/following-sibling::p")).getText(), "There is no product that matches the search criteria.");
